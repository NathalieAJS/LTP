...
# python2 download_tweets.py tweeti-a.dev.dist.tsv > tweeti-a-dev-dist-tweets.txt
# python2 download_tweets.py tweeti-b.dev.dist.tsv > tweeti-a-dev-dist-tweets.txt
# python2 download_tweets.py tweeti-a.dist.tsv > tweeti-a-dev-dist-tweets.txt
# python2 download_tweets.py tweeti-b.dist.tsv > tweeti-a-dev-dist-tweets.txt
