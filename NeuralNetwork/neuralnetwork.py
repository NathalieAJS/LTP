...
positive_sentences = [l.strip() for l in open("TestSentences/Positive/positivetweet.txt").readlines()]
negative_sentences = [l.strip() for l in open("TestSentences/Negative/negativetweet.txt").readlines()]
objective_sentences = [l.strip() for l in open("TestSentences/Objective/objectivetweet.txt").readlines()]
neutral_sentences = [l.strip() for l in open("TestSentences/Neutral/neutraltweet.txt").readlines()]
...
model.fit(X_train_pad, y_train_1hot_pad, epochs=4)
